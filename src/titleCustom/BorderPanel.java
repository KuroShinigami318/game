...
import Game_Client.Client_Connection;
...
public class BorderPanel extends JPanel{
    ...
    private JPanel customPanel(JFrame frame){
        ...
        minimize = new ImageIcon(new ImageIcon(this.getClass().getResource("/icons/min.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
        ...
        maximize = new ImageIcon(new ImageIcon(this.getClass().getResource("/icons/max.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
        restoreDown = new ImageIcon(new ImageIcon(this.getClass().getResource("/icons/restore.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
        ...
        closeI = new ImageIcon(new ImageIcon(this.getClass().getResource("/icons/close.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
        ...
        close.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e){
                if(JOptionPane.showConfirmDialog(frame, "Bạn có muốn thoát game?", "WARNING", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
                    ObjectOutputStream oos = null;
                    try {
                        oos = Client_Connection.getOos();
                        oos.writeObject(new communication_transfer(Client_Connection.getNickName(),Client_Connection.getClientID(),"server","close","closeClient"));
                        oos.close();
                        Client_Connection.getOis().close();
                        Client_Connection.getClient().close();
        ...
        btnPane.add(max);
        btnPane.add(close);
        cPanel.add(btnPane,BorderLayout.CENTER);     
